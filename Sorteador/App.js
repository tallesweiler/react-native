...
import NumeroDePessoas from './componentes/NumeroDePessoas'
import BotarSortear from './componentes/BotaoSortear'
...
export default function Sorteador() {
  ...
  return(
    <SafeAreaView>
      ...
      <Nomes setarNome={setNome} adicionarNome={recebeNome} listaNomes={listaNomes} limparNomes={limpaNomes}/>
      <BotarSortear/>
    </SafeAreaView>
  )
}
