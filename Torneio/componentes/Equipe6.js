...
export default function Equipe1() {
    const [at1,setAt1]=useState(Globais.fat1)
    const [at2,setAt2]=useState(Globais.fat2)
    const [at3,setAt3]=useState(Globais.fat3)
    const [at5v,setAt5v]=useState(Globais.fat5v)
    const [at51v,setAt51v]=useState(Globais.fat51v)
    const [at52v,setAt52v]=useState(Globais.fat52v)
    const [at53v,setAt53v]=useState(Globais.fat53v)
    const [at54v,setAt54v]=useState(Globais.fat54v)
    const [at5a,setAt5a]=useState(Globais.fat5a)
    const [at51a,setAt51a]=useState(Globais.fat51a)
    const [at52a,setAt52a]=useState(Globais.fat52a)
    const [at53a,setAt53a]=useState(Globais.fat53a)
    const [at54a,setAt54a]=useState(Globais.fat54a)
    const [at5l,setAt5l]=useState(Globais.fat5l)
    const [at51l,setAt51l]=useState(Globais.fat51l)
    const [at52l,setAt52l]=useState(Globais.fat52l)
    const [at53l,setAt53l]=useState(Globais.fat53l)
    const [at54l,setAt54l]=useState(Globais.fat54l)
    const [at6,setAt6]=useState(Globais.fat6)
    const [gap,setGap]=useState(Globais.fgap)
    const [teste,setTeste]=useState(Globais.teste6)
    ...
    function marcaTodosVermelho() {
        if (at5v) {
            ...
            setAt54v(false)
            Globais.fat5v=false
            Globais.fat51v=false
            Globais.fat52v=false
            Globais.fat53v=false
            Globais.fat54v=false
        }
        else {
            setAt5v(true)
            setAt51v(true)
    ...
    function marcaTodosAmarelo() {
        if (at5a) {
            ...
            setAt54a(false)
            Globais.fat5a=false
            Globais.fat51a=false
            Globais.fat52a=false
            Globais.fat53a=false
            Globais.fat54a=false
        }
        else {
            setAt5a(true)
            setAt51a(true)
    ...
    function marcaTodosLilas() {
        if (at5l) {
            ...
            setAt54l(false)
            Globais.fat5l=false
            Globais.fat51l=false
            Globais.fat52l=false
            Globais.fat53l=false
            Globais.fat54l=false
        }
        else {
            setAt5l(true)
            setAt51l(true)
    ...
    const [seconds,setSeconds]=useState(Globais.seconds6)
    const [minutes,setMinutes]=useState(Globais.minutes6)
    ...
    function marcarTempo(atv) {
        if (minutes<10 && seconds>9)
            Globais.resultado6+=atv+' aos 0'+minutes+':'+seconds+'\n'
        else if (minutes>9 && seconds<10)
            Globais.resultado6+=atv+' aos '+minutes+':0'+seconds+'\n'
        else
            Globais.resultado6+=atv+' aos 0'+minutes+':0'+seconds+'\n'
    }    
